...
function getData () {
    tblClient = $('#data').DataTable({
        ...
        columns: [
            ...
            {"data": "vendedor"}, // Específicamente definir la columna 'vendedor' aquí
            {"data": "estado_deuda"},
        ],
        columnDefs: [
            {
                ...
                orderable: false,
                render: function (data, type, row) {
                    var buttons = '<a href="#" rel="detalle" type="button" class="btn btn-secondary btn-xs btn-flat"><i class="bi bi-clock-history"></i></a> ';
                    return buttons;
                }
            },
        ],
